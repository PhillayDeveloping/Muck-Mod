...
@Mod("muckmod")
public class MuckmodMod {
	public static final Logger LOGGER = LogManager.getLogger(MuckmodMod.class);
	public static final String MODID = "muckmod";
	...
	public MuckmodMod() {
		...
		MuckmodModBlocks.REGISTRY.register(bus);
		MuckmodModItems.REGISTRY.register(bus);
