...
public class KingGolemEntity extends PathfinderMob {
	...
	public KingGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MuckmodModEntities.KING_GOLEM.get(), world);
	}

	public KingGolemEntity(EntityType<KingGolemEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("King Golem"));
