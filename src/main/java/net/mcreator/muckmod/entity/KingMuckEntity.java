...
package net.mcreator.muckmod.entity;
...
public class KingMuckEntity extends Monster {
	...
	public KingMuckEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MuckmodModEntities.KING_MUCK.get(), world);
	}

	public KingMuckEntity(EntityType<KingMuckEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(MuckmodModItems.MUCK_MUSIC.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(MuckmodModEntities.KING_MUCK.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
